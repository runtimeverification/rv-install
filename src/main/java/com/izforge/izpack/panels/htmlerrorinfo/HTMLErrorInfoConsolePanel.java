 ...
 * @author Tim Anderson
 */
public class HTMLErrorInfoConsolePanel extends AbstractTextConsolePanel
{
    private final Resources resources;
    private final String panelId;
    private final String resourcePrefix;

    public HTMLErrorInfoConsolePanel(PanelView<ConsolePanel> panel, Resources resources)
    {
        this(panel, resources, "HTMLErrorInfoPanel");
    }

    public HTMLErrorInfoConsolePanel(PanelView<ConsolePanel> panel, Resources resources, String resourcePrefix)
    {
        super(panel);
