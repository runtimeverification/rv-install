 ...
 * @author Tim Anderson
 */
public class HTMLWarningInfoConsolePanel extends AbstractTextConsolePanel
{
    private final Resources resources;
    private final String panelId;
    private final String resourcePrefix;

    public HTMLWarningInfoConsolePanel(PanelView<ConsolePanel> panel, Resources resources)
    {
        this(panel, resources, "HTMLWarningInfoPanel");
    }

    public HTMLWarningInfoConsolePanel(PanelView<ConsolePanel> panel, Resources resources, String resourcePrefix)
    {
        super(panel);
