...
/**
 * The HTML info panel.
 * Based on com.izforge.izpack.panels.htmlinfo.HTMLInfoPanel, IZPack 5.0
 *
 * @author Julien Ponge
 */
public class HTMLFinishInfoPanel extends IzPanel
{
    ...
    /**
     * Constructs an <tt>HTMLFinishInfoPanel</tt>.
     *
     ...
     * @param log         the log
     */
    public HTMLFinishInfoPanel(Panel panel, InstallerFrame parent, GUIInstallData installData, Resources resources, Log log)
    {
        this(panel, parent, installData, "HTMLFinishInfoPanel", true, resources, log);
    }
     ...
     * @param log               the log
     */
    public HTMLFinishInfoPanel(Panel panel, InstallerFrame parent, GUIInstallData installData,
    ...
    public void panelActivate()
    {
        ...
        try
        {
            if (!installData.isInstallSuccess()) {
                textArea.setPage("Install failed!  Please try again or contact us for support.");
                return;
            }
            textArea.setPage(loadHTMLInfoContent());
            textArea.setCaretPosition(0);
