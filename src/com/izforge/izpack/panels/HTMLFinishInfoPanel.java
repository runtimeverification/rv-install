...
/**
 * The HTML Finish info panel.
 * Based on com.izforge.izpack.panels.HTMLInfoPanel, IZPack 4.3
 *
 * @author Julien Ponge
 */
public class HTMLFinishInfoPanel extends IzPanel
{
     ...
     */
    public HTMLFinishInfoPanel(InstallerFrame parent, InstallData idata)
    {
        this(parent,idata,"HTMLFinishInfoPanel",false);
    }
